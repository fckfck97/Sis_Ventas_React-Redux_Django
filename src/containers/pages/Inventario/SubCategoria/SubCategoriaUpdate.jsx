...
import { subcategoriaUpdateURL } from "constants";
...
function SubCategoriaUpdate({ get_categoria_list, categoria_list }) {
  useEffect(() => {
    get_categoria_list();
  }, []);
  ...
  const onSubmit = (e) => {
    ...
    if (categoria) {
      ...
      const fetchData = async () => {
        axios
          .put(`${subcategoriaUpdateURL}${params.id}`, formData, config)
          .then((res) => {
            setLoading(false);
