...
const ProductoList = ({ producto_list }) => {
  return (
    <div>
      {producto_list ? (
        <>
          ...
          <div class="overflow-x-auto flow-root relative">
                ...
                {producto_list.map((producto) => (
                  <>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td class="py-4 px-6">{producto.existencia}</td>
                      <td class="py-4 px-6">
                      ...
                      <td>
                        {" "}
                        <Link to={`/producto-update/${producto.id}`}>
                          <button
                            type="button"
...
export default connect(mapStateToProps, {})(ProductoList);
