...
import { proveedorDeleteURL } from "constants";
import Delete from "components/loaders/Delete";

const ProveedorList = ({ proveedor_list }) => {
                ...
                {proveedor_list.map((proveedor) => (
                  <>
                    ...
                    >
                      ...
                      <td class="py-4 px-6">{proveedor.razon_social}</td>
                      <td class="py-4 px-6">{proveedor.tipo}</td>
                      <td class="py-4 px-6">{proveedor.rif}</td>
                      <td class="py-4 px-6">{proveedor.direccion}</td>
                      ...
                      <td>
                        {" "}
                        <Link to={`/proveedor-update/${proveedor.id}`}>
                          <button
                            type="button"
                        ...
                        onClick={() =>
                          proveedor.id &&
                          handleDelete(proveedorDeleteURL, proveedor.id)
                        }
                          type="button"
...
export default connect(mapStateToProps, {})(ProveedorList);
